...
struct ChatConfig: Codable {
    ...
    Quant backend: quant_analysis(symbol,timeframe[,account_size]) · backtest(symbol,timeframe[,fast,slow]) · risk_plan(symbol,timeframe[,account_size,win_rate,payoff_ratio]) · structure_confluence(symbol,timeframe)
