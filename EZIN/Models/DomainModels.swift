...
struct PipelineStage: Codable, Identifiable, Hashable {
    ...
    enum Kind: String, Codable, CaseIterable {
        ...
        case aiParse = "AI Parse & Classify"
        case aiContext = "AI Context Retrieval"
        case aiReasoning = "AI Deep Reasoning"
        case aiThinking = "AI Chain-of-Thought"
        case aiToolSelection = "AI Tool Selection"
        case aiAnalysis = "AI Analysis & Synthesis"
        case aiVerification = "AI Verification"
        case aiReflection = "AI Self-Reflection"
        case aiRefinement = "AI Response Refinement"
